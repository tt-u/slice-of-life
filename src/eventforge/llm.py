        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Each template includes impact_tier, commitment_tier, cost_types, tags, trigger_dimensions, upside_axes, downside_axes, tactic_family, primary_dimension, and sampled_for. "
                    "Treat the provided templates as the sampled candidate set: do not invent new actions, rationalize and phrase these sampled options so they fit the current turn. "
